...
//Draw Triangle
void LCD_Draw_Triangle_Fill(uint16_t xPos, uint16_t yPos, uint16_t btmLen, uint16_t color) {
	uint16_t xOffset = 0;
	int help = 0;
	while (btmLen > 0) {
		for (uint16_t i = 0; i < btmLen; i++) {
			  LCD_Draw_Pixel(xPos + i + xOffset, yPos, color);
		}
		switch(help) {
			case 0:
				btmLen -= 2;
...
//	LCD_DisplayChar(140,140,'d');
//	LCD_DisplayChar(155,140,'=');

//	LCD_Draw_Square_Fill(100, 180, 50, LCD_COLOR_BLACK);

//	LCD_Draw_Triangle_Fill(80, 300, 100, LCD_COLOR_BLACK);

//	int DataReturned = RNG_App_Get();
//
//	LCD_DisplayChar(95,160, '0' + DataReturned);
//
//	LCD_Draw_Circle_Fill((DataReturned % 80) + 40,150,5,LCD_COLOR_BLACK);
//
//	DataReturned = RNG_App_Get();
//
//	LCD_DisplayChar(95,180, '0' + DataReturned);
//
//	LCD_Draw_Circle_Fill((DataReturned % 80) + 40,150,5,LCD_COLOR_BLACK);
//
//	DataReturned = RNG_App_Get();
//
//	LCD_DisplayChar(95,200, '0' + DataReturned);
//
//	LCD_Draw_Circle_Fill((DataReturned % 80) + 40,150,5,LCD_COLOR_BLACK);

//	printf("The RNG # is: %d \n", DataReturned);
//	LCD_DisplayChar(110,160,'p');
//
//	LCD_DisplayChar(130,160,'b');
//	LCD_DisplayChar(140,160,'r');
//	LCD_DisplayChar(150,160,'o');
